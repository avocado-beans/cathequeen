...
heart = ['face817.jpg', 'face1072.jpg', 'face519.jpg', 'face1966.jpg', 'face412.jpg', 'face441.jpg']
...
def parse():
    data = requests.get(url = pyanyurl)
    return(data.json()['data'][0])

def update(new_data):
    payload = {'data': new_data}
    data = requests.post(url = pyanyurl, params=payload)
    return(data.json()['data'][0])
